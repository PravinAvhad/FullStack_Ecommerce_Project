...
export const loginuser = (email,password)=> async(dispatch) =>{
    try {
        ...
        const {data} = await axios.post(`https://fullstack-ecommerce-project-backend.onrender.com/api/v2/login`,{email,password},config);
        // console.log(data);
...
export const registeruser = (name,email,password,avatar)=> async(dispatch) =>{
    try {
        ...
        const {data} = await axios.post(`https://fullstack-ecommerce-project-backend.onrender.com/api/v2/register`,{name,email,password,avatar},config);
        // console.log(data);
...
export const loaduser = ()=> async(dispatch) =>{
    try {
        ...
        const {data} = await axios.get(`https://fullstack-ecommerce-project-backend.onrender.com/api/v2/me/profile`);
        // console.log(data);
...
export const updateProfile = (name,email,avatar)=> async(dispatch) =>{
    try {
        ...
        const config = {headers:{"Content-Type":"multipart/form-data"}};
        const {data} = await axios.put(`https://fullstack-ecommerce-project-backend.onrender.com/api/v2/me/updateprofile`,{name,email,avatar},config);
...
export const updatePassword = (oldpassword,newpassword,confirmpassword)=> async(dispatch) =>{
    try {
        ...
        const config = {headers:{"Content-Type":"application/json"}};
        const {data} = await axios.put(`https://fullstack-ecommerce-project-backend.onrender.com/api/v2/me/password/update`,{oldpassword,newpassword,confirmpassword},config);
        // console.log(data);
...
export const sendemail = (email)=> async(dispatch)=>{
    try {
        ...
        const config = {headers:{"Content-Type":"application/json"}};
        const data = await axios.post("https://fullstack-ecommerce-project-backend.onrender.com/api/v2/password/forget",email,config);
        // console.log(data);
...
export const admingetallUsers = ()=> async(dispatch) =>{
    try {
        ...
        const {data} = await axios.get(`https://fullstack-ecommerce-project-backend.onrender.com/api/v2/admin/users`);
        // console.log(data);
...
export const admingetUserDetail = (id)=> async(dispatch) =>{
    try {
        ...
        const {data} = await axios.get(`https://fullstack-ecommerce-project-backend.onrender.com/api/v2/admin/user/${id}`);
        // console.log(data);
...
export const updateUser = (id,userData)=> async(dispatch) =>{
    try {
        ...
        const config = {headers:{"Content-Type":"application/json"}};
        const {data} = await axios.put(`https://fullstack-ecommerce-project-backend.onrender.com/api/v2/admin/user/${id}`,userData,config);
        // console.log(data);
...
export const deleteUser = (id)=> async(dispatch) =>{
    try {
        ...
        const {data} = await axios.delete(`https://fullstack-ecommerce-project-backend.onrender.com/api/v2/admin/user/${id}`);
        // console.log(data);
